...
-- Custom keymaps
vim.keymap.set('n', '<leader>pv', vim.cmd.Ex, { desc = 'Go back to file tree' })
vim.keymap.set('n', '<C-s>', vim.cmd.w, { desc = 'Save file' })
vim.keymap.set('n', '<C-l>', 'V', { desc = 'Highlight current line' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Hover/preview
          map('K', vim.lsp.buf.hover, 'Hover/preview')
